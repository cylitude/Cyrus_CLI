...
class TestCLI(unittest.TestCase):
    def run_cli(self, args):
        ...
        try:
            # main may call sys.exit() for --help; catch it
            try:
                cli_main()
            except SystemExit:
                pass
    ...
    def test_search_found_and_header(self):
        # First, generate seeded list and capture one name
